module github.com/ProjectAthenaa/footsites

go 1.17

require (
	github.com/CrimsonAIO/adyen v1.2.3
	github.com/ProjectAthenaa/newbalance v0.0.0-20210907055942-74f501b2fe75
...
require (
	...
	github.com/CrimsonAIO/aesccm v1.0.0 // indirect
